...
function OrionLib:MakeWindow(WindowConfig)
    ...
    if WindowConfig.Name == "Night Hub" then WindowConfig.Name = "Cặc Hub V2" else WindowConfig.Name = "Your Mom Fat" end
	...
	WindowConfig.IntroText = "Cặc Hub"
	...
	function TabFunction:MakeTab(TabConfig)
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddLabel(Text)
                if Text:find("Script By LMNGAMING X") then Text = "Script By Hirimi, Zero X VUQUOCOAI"
